...
class TextRecognizer(object):
    def __init__(self):
        ...
        v = "3, 32, 320"
        self.rec_image_shape = [int(v) for v in v.split(",")]
        ...
        char_ops_params = {
            "character_type": "ch",
            "character_dict_path": "/home/eaibot/moveit_ws/src/moveit/visual_grab/src/paddleocr/ppocr/utils/ppocr_keys_v1.txt",
            "use_space_char": True,
            "max_text_length": 25
        }
